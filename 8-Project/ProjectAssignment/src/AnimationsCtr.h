...
//Delta to change speed by
#define SPEED_STEP 5



//Animation mode - showing demos or selecting colour
enum AnimationsMode {AnimationsDemos, AnimationsSetRed, AnimationsSetGreen, AnimationsSetBlue, AnimationsSetSpeed};
...
private:
	...
	//Speed picker object
	SpeedPicker xSpeedPicker;

	//Power On or Off for LED
	bool xPower = false;
};
