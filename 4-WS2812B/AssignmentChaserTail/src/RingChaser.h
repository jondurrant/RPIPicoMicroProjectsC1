 ...
 * RingChaser.h
 *
 * WS2812B LED Ring animation to chase a single pixel around the ring
 *
 *  Created on: 15 Jun 2022
 *      Author: jondurrant
 */

#ifndef WS2812B_RINGANIMATION_SRC_RINGCHASER_H_
#define WS2812B_RINGANIMATION_SRC_RINGCHASER_H_

#include "RingAnimation.h"

class RingChaser : public RingAnimation{
public:
	/***
	 * Default constructor
...
#endif /* WS2812B_RINGANIMATION_SRC_RINGCHASER_H_ */
